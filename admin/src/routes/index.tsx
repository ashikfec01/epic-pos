...
const Warehouse = lazy(() => import(/* webpackChunkName: "404'"*/ '@/pages/warehouse'));
const Rack = lazy(() => import(/* webpackChunkName: "404'"*/ '@/pages/rack'));
const Brand = lazy(() => import(/* webpackChunkName: "404'"*/ '@/pages/brand'));
...
const routeList: RouteObject[] = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'product',
        element: <WrapperRouteComponent element={<ProductPage loading={false} />} titleId="title.product" />,
      },
      {
        path: 'documentation',
      ...
      {
        path: 'warehouse',
        element: <WrapperRouteComponent element={<Warehouse />} titleId="title.warehouse" />,
      },
      {
        path: 'rack',
        element: <WrapperRouteComponent element={<Rack />} titleId="title.documentation" />,
      },
      {
        path: 'brand',
        element: <WrapperRouteComponent element={<Brand />} titleId="title.documentation" />,
      },
      {
        path: 'guide',
